...
public class userlogin extends AppCompatActivity {
    ...
    Button b;
    TextView tv,tv2;
    String url= "https://annalprojects.000webhostapp.com/userauth.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i =new Intent(getApplicationContext(),usercreate.class);
                startActivity(i);
            }
        });
                    ...
                    final StringRequest stringRequest = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
                        ...
                        public void onResponse(String response) {
                            ...
                            if(response.equals("1"))
                            {
                                ...
                                Intent i=new Intent(getApplicationContext(),ordercan.class);
                                startActivity(i);
                            }
                            else
                                Toast.makeText(getApplicationContext(), "You are not a valid user!!", Toast.LENGTH_LONG).show();
